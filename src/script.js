    ...
    it: {
        ...
        Gozosos: {
            ...
            timeline: [
                ...
                { s: 327, img: "src/img/gozosos/gozosos_2.png" },      // 6:33 -> (6*60)+33 = 393
                { s: 610, img: "src/img/gozosos/gozosos_3.png" },      // 11:40 -> (11*60)+40 = 700
                { s: 878, img: "src/img/gozosos/gozosos_4.png" },     // 16:45 -> (16*60)+45 = 1005
                { s: 1160, img: "src/img/gozosos/gozosos_5.png" },     // 21:47 -> (21*60)+47 = 1307
                { s: 1747, img: "src/img/letanias.png" },      // 27:02 -> (27*60)+2 = 1622
            ]
        },
        Dolorosos: {
        ...
        Gloriosos: {
            ...
            timeline: [
                { s: 0, img: "src/img/gloriosos/gloriosos.png" },          // 0:00
                { s: 53, img: "src/img/gloriosos/gloriosos_1.png" },       // 1:22 -> (1*60)+22 = 80
                { s: 327, img: "src/img/gloriosos/gloriosos_2.png" },      // 6:33 -> (6*60)+33 = 393
                { s: 610, img: "src/img/gloriosos/gloriosos_3.png" },      // 11:40 -> (11*60)+40 = 700
                { s: 878, img: "src/img/gloriosos/gloriosos_4.png" },     // 16:45 -> (16*60)+45 = 1005
                { s: 1160, img: "src/img/gloriosos/gloriosos_5.png" },     // 21:47 -> (21*60)+47 = 1307
                { s: 1622, img: "src/img/letanias.png" },      // 27:02 -> (27*60)+2 = 1622
            ]
        }
    },
